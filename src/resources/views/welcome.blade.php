...
<head>
    ...
    <style>
        ...
        .hero-avatar-ring {
            ...
            padding: 4px;
            border-radius: 50%;
            background: conic-gradient(from 0deg, #a855f7, #0A66C2, #ec4899, #a855f7);
            ...
            <section class="relative overflow-hidden">
                <div class="mx-auto {{ $siteWidth ?? 'max-w-7xl' }} px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-32 sm:pb-32 lg:pt-40 lg:pb-40 relative">
                    <div class="text-center w-full">
                        ...
                        <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 opacity-0 animate-fade-in-up animate-delay-400">
            ...
            <section class="border-t border-gray-200 dark:border-white/5">
                <div class="mx-auto {{ $siteWidth ?? 'max-w-7xl' }} px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                        <div class="group rounded-2xl border border-gray-200 dark:border-white/5 bg-white dark:bg-white/[0.02] p-6 lg:p-8 hover:border-[#a855f7]/40 transition-colors shadow-sm dark:shadow-none opacity-0 animate-fade-in-up animate-delay-200">
                        ...
                        <div class="group rounded-2xl border border-gray-200 dark:border-white/5 bg-white dark:bg-white/[0.02] p-6 lg:p-8 hover:border-[#a855f7]/40 transition-colors shadow-sm dark:shadow-none opacity-0 animate-fade-in-up animate-delay-300">
                            <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-[#a855f7]/10 text-[#a855f7]">
                        ...
                        <div class="group rounded-2xl border border-gray-200 dark:border-white/5 bg-white dark:bg-white/[0.02] p-6 lg:p-8 hover:border-[#a855f7]/40 transition-colors shadow-sm dark:shadow-none opacity-0 animate-fade-in-up animate-delay-400">
                            <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-[#a855f7]/10 text-[#a855f7]">
