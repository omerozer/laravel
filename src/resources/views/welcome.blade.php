...
<head>
    ...
    <style>
        ...
        .hero-title-gradient {
            background: linear-gradient(90deg, #00ff99, #e0ffe8, #ffffff, #b8ffd4, #00ff99);
                ...
                <div class="mx-auto {{ $siteWidth ?? 'max-w-7xl' }} px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-32 sm:pb-32 lg:pt-40 lg:pb-40 relative">
                    <div class="text-center max-w-4xl mx-auto">
                        <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <span class="block hero-title-gradient">
                                İşinizi Yöneten Özel Yazılımlar
                            </span>
                        </h1>
                        ...
                        <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                            <a href="https://www.linkedin.com/in/omerdesign/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 rounded-lg bg-accent-500 px-6 py-3 text-base font-semibold text-black hover:bg-accent-400 transition-colors focus:outline-none focus:ring-2 focus:ring-accent-500/50 focus:ring-offset-2 focus:ring-offset-black" aria-label="LinkedIn">
            ...
            <section class="border-t border-gray-200 dark:border-white/5">
                <div class="mx-auto {{ $siteWidth ?? 'max-w-7xl' }} px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                        <div class="group rounded-2xl border border-gray-200 dark:border-white/5 bg-white dark:bg-white/[0.02] p-6 lg:p-8 hover:border-accent-500/30 transition-colors shadow-sm dark:shadow-none">
                            <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-accent-500/10 text-accent-500">
